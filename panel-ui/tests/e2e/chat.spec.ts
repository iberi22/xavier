...
test.describe("Agent Chat Interactions", () => {
  ...
  test("should send a message and show assistant response", async ({
    page,
  }) => {
          ...
          messages: [
            {
              id: "1",
              role: "user",
              plain_text: userInput,
              created_at: new Date().toISOString(),
            },
            {
              id: "2",
              role: "assistant",
              plain_text: "Hello! I am Xavier, your cognitive assistant.",
              created_at: new Date().toISOString(),
            },
          ],
        },
    ...
    await expect(page.getByText(userInput).first()).toBeVisible();
    await expect(
      page.getByText("Hello! I am Xavier, your cognitive assistant."),
    ).toBeVisible();
  ...
  test("should handle command triggers starting with /", async ({ page }) => {
        ...
        json: {
          ...
          messages: [
            ...
            },
            {
              id: "2",
              role: "assistant",
              plain_text: "Initiating scan of current directory...",
              created_at: new Date().toISOString(),
            },
          ],
        },
    ...
    await expect(
      page.getByText("Initiating scan of current directory..."),
    ).toBeVisible();
