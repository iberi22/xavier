 ...
 *
 * 💡 What: Extracted bookmark card into BookmarkCardItem and wrapped in React.memo()
 * 🎯 Why: When editing a bookmark or changing categories, BookmarksView re-rendered the
 *         entire grid of bookmarks. By memoizing the cards, we avoid O(N) re-renders
 *         and SVG DOM reconciliation for bookmarks that haven't changed.
 * 📊 Impact: Eliminates O(N) re-renders for unchanged bookmarks.
 */
interface BookmarkCardProps {
  b: BookmarkArtifact;
  onPinArtifact: (b: BookmarkArtifact) => void;
  onUpdateBookmark: (b: BookmarkArtifact) => void;
}
