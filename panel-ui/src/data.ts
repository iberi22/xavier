  ...
  nodes: [
    {
      ...
      decisions: [
        "Opted for a distributed architecture",
        "Selected Rust as core systems language",
      ],
      commits: [
        "ca82a6d - Initial repo setup",
        "1b9d4f2 - Add organization charter",
      ],
    ...
    },
    {
      ...
      label: "Project Nova",
      type: "project",
      description: "Next-gen AI deployment",
      parentId: "org_nexus",
      date: "2025-05-15",
      ...
      decisions: [
        "Adopted Ring Attention mechanism",
        "Shifted from GPU to TPU clusters for cost",
      ],
      commits: [
        "4f81c9a - Add Ring Attention prototype",
        "901bca1 - Benchmark TPU inference times",
      ],
      iterations: [
        "Iteration 1: Naive attention",
        "Iteration 2: FlashAttention",
        "Iteration 3: Ring Attention",
      ],
    },
    {
      id: "sub_nlp",
      label: "NLP Engine",
      type: "subproject",
      description: "Deep learning core",
      parentId: "proj_nova",
      date: "2025-08-20",
    ...
    },
    {
      ...
      label: "UI Sandbox",
      type: "subproject",
      description: "Frontend experimentation",
      parentId: "proj_nova",
      date: "2025-09-01",
      milestone: "Beta Release",
    },
    {
      ...
      label: "Sprint 14",
      type: "session",
      description: "Evaluation of Q2 metrics",
      parentId: "sub_nlp",
      date: "2026-04-10",
      milestone: "RC1",
    },
    {
      ...
      label: "Project Aegis",
      type: "project",
      description: "Security protocol overhaul",
      parentId: "org_nexus",
      date: "2026-01-10",
      milestone: "Alpha Release",
    },
    ...
    {
      id: "org_acq",
      label: "Acquired Tech Inc",
      type: "organization",
      description: "Recent tech acquisition",
      parentId: "org_nexus",
      date: "2026-05-20",
