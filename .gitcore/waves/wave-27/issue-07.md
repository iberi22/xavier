# [WAVE-27.07] feat-telecom-file-drawer — FileTransferDrawer chunk progress & SHA-256 integrity verifier

> Wave 27 — Autonomous Maintenance, Multi-Node Telecom UI & Hardening. Labels: `wave-27`, `ola27` (sin `jules` todavía)
> Merge order: 7/30 | Risk: MED | Effort: Medium 2-4h | Assigned: Cuenta A (Frontend)

---

## Current State (MEDIBLE)

- File: `panel-ui/src/components/Telecom/FileTransferDrawer.tsx` (0 lines - create new component)
...
- Need: Implement FileTransferDrawer showing upload/download chunk progress bar, transfer rate (KB/s), SHA-256 verification hash, and open file trigger.

## Desired State (DELTA)

- **Target file**: `panel-ui/src/components/Telecom/FileTransferDrawer.tsx`
- Requirements:
  - Implement FileTransferDrawer showing upload/download chunk progress bar, transfer rate (KB/s), SHA-256 verification hash, and open file trigger.
  - Strictly maintain 100% disjoint file isolation (touch ONLY `panel-ui/src/components/Telecom/FileTransferDrawer.tsx`).
  - Zero-warning clean compilation and comprehensive unit test coverage.
- Risk: MED — localized strictly to `panel-ui/src/components/Telecom/FileTransferDrawer.tsx`.

## 🌐 Web Research Required

**MANDATORY — 4 queries. El agente DEBE investigar antes de implementar.**
1. search: "File upload progress drawer React Tailwind"
2. search: "Chunked transfer progress calculation"
3. search: "Hash verification checkmark animation"
4. search: "Accessible drawer dialog aria-modal"
...
4. Ensure your implementation lives strictly in `panel-ui/src/components/Telecom/FileTransferDrawer.tsx` without modifying other files."
...
- [ ] `grep -cE "FileTransferDrawer|chunkProgress" panel-ui/src/components/Telecom/FileTransferDrawer.tsx >= 1`
...
|------|--------------|--------|------|
| `panel-ui/src/components/Telecom/FileTransferDrawer.tsx` | 0 lines - create new component | Implement feat-telecom-file-drawer requirements | MED |
...
- [ ] `git status --porcelain` shows `panel-ui/src/components/Telecom/FileTransferDrawer.tsx` modified/untracked BEFORE opening PR.
