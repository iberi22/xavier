# [WAVE-27.02] feat-telecom-direct-chat-view — DirectChatView 1-to-1 encrypted conversation window & receipts

> Wave 27 — Autonomous Maintenance, Multi-Node Telecom UI & Hardening. Labels: `wave-27`, `ola27` (sin `jules` todavía)
> Merge order: 2/30 | Risk: MED | Effort: Medium 2-4h | Assigned: Cuenta A (Frontend)

---

## Current State (MEDIBLE)

- File: `panel-ui/src/components/Telecom/DirectChatView.tsx` (0 lines - create new component)
...
- Need: Implement DirectChatView with message stream, sent/delivered/read receipt checkmarks, and auto-scroll to bottom with AnimatePresence.

## Desired State (DELTA)

- **Target file**: `panel-ui/src/components/Telecom/DirectChatView.tsx`
- Requirements:
  - Implement DirectChatView with message stream, sent/delivered/read receipt checkmarks, and auto-scroll to bottom with AnimatePresence.
  - Strictly maintain 100% disjoint file isolation (touch ONLY `panel-ui/src/components/Telecom/DirectChatView.tsx`).
  - Zero-warning clean compilation and comprehensive unit test coverage.
- Risk: MED — localized strictly to `panel-ui/src/components/Telecom/DirectChatView.tsx`.

## 🌐 Web Research Required

**MANDATORY — 4 queries. El agente DEBE investigar antes de implementar.**
1. search: "React chat message list auto scroll effect"
2. search: "Delivery and read receipt ticks UI pattern"
3. search: "Encrypted message bubble styling Tailwind"
4. search: "React 19 optimistic message rendering"
...
4. Ensure your implementation lives strictly in `panel-ui/src/components/Telecom/DirectChatView.tsx` without modifying other files."
...
- [ ] `grep -cE "DirectChatView|MessageItem" panel-ui/src/components/Telecom/DirectChatView.tsx >= 1`
...
|------|--------------|--------|------|
| `panel-ui/src/components/Telecom/DirectChatView.tsx` | 0 lines - create new component | Implement feat-telecom-direct-chat-view requirements | MED |
...
- [ ] `git status --porcelain` shows `panel-ui/src/components/Telecom/DirectChatView.tsx` modified/untracked BEFORE opening PR.
