# [WAVE-27.11] feat-telecom-ephemeral-toggle — EphemeralMessageToggle accessible switch for OTR autodestruct messages

> Wave 27 — Autonomous Maintenance, Multi-Node Telecom UI & Hardening. Labels: `wave-27`, `ola27` (sin `jules` todavía)
> Merge order: 11/30 | Risk: MED | Effort: Medium 2-4h | Assigned: Cuenta A (Frontend)

---

## Current State (MEDIBLE)

- File: `panel-ui/src/components/Telecom/EphemeralMessageToggle.tsx` (0 lines - create new component)
...
- Need: Implement EphemeralMessageToggle accessible button with role="switch", aria-checked, TTL selector (30s, 5m, 1h), and focus-visible styling.

## Desired State (DELTA)

- **Target file**: `panel-ui/src/components/Telecom/EphemeralMessageToggle.tsx`
- Requirements:
  - Implement EphemeralMessageToggle accessible button with role="switch", aria-checked, TTL selector (30s, 5m, 1h), and focus-visible styling.
  - Strictly maintain 100% disjoint file isolation (touch ONLY `panel-ui/src/components/Telecom/EphemeralMessageToggle.tsx`).
  - Zero-warning clean compilation and comprehensive unit test coverage.
- Risk: MED — localized strictly to `panel-ui/src/components/Telecom/EphemeralMessageToggle.tsx`.

## 🌐 Web Research Required

**MANDATORY — 4 queries. El agente DEBE investigar antes de implementar.**
1. search: "Accessible switch button component React ARIA"
2. search: "Off the record ephemeral message timer UI"
3. search: "Focus-visible ring styling Tailwind switch"
4. search: "TTL dropdown selector component"
...
4. Ensure your implementation lives strictly in `panel-ui/src/components/Telecom/EphemeralMessageToggle.tsx` without modifying other files."
...
- [ ] `grep -c "role=\"switch\"" panel-ui/src/components/Telecom/EphemeralMessageToggle.tsx >= 1`
- [ ] `grep -c "aria-checked" panel-ui/src/components/Telecom/EphemeralMessageToggle.tsx >= 1`
...
|------|--------------|--------|------|
| `panel-ui/src/components/Telecom/EphemeralMessageToggle.tsx` | 0 lines - create new component | Implement feat-telecom-ephemeral-toggle requirements | MED |
...
- [ ] `git status --porcelain` shows `panel-ui/src/components/Telecom/EphemeralMessageToggle.tsx` modified/untracked BEFORE opening PR.
