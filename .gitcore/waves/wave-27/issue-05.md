# [WAVE-27.05] feat-telecom-clearance-badge — ClearanceBadge visual classification component (TopSecret/Secret/Unclassified)

> Wave 27 — Autonomous Maintenance, Multi-Node Telecom UI & Hardening. Labels: `wave-27`, `ola27` (sin `jules` todavía)
> Merge order: 5/30 | Risk: MED | Effort: Medium 2-4h | Assigned: Cuenta A (Frontend)

---

## Current State (MEDIBLE)

- File: `panel-ui/src/components/Telecom/ClearanceBadge.tsx` (0 lines - create new component)
...
- Need: Implement ClearanceBadge with distinct color tokens (Red/Amber/Blue/Emerald) for TopSecret, Secret, Confidential, and Unclassified levels with tooltip descriptions.

## Desired State (DELTA)

- **Target file**: `panel-ui/src/components/Telecom/ClearanceBadge.tsx`
- Requirements:
  - Implement ClearanceBadge with distinct color tokens (Red/Amber/Blue/Emerald) for TopSecret, Secret, Confidential, and Unclassified levels with tooltip descriptions.
  - Strictly maintain 100% disjoint file isolation (touch ONLY `panel-ui/src/components/Telecom/ClearanceBadge.tsx`).
  - Zero-warning clean compilation and comprehensive unit test coverage.
- Risk: MED — localized strictly to `panel-ui/src/components/Telecom/ClearanceBadge.tsx`.

## 🌐 Web Research Required

**MANDATORY — 4 queries. El agente DEBE investigar antes de implementar.**
1. search: "Security classification badge component React"
2. search: "Accessible high-contrast badge colors WCAG"
3. search: "Tailwind badge tooltip styling"
4. search: "Role based badge iconography Lucide"
...
4. Ensure your implementation lives strictly in `panel-ui/src/components/Telecom/ClearanceBadge.tsx` without modifying other files."
...
- [ ] `grep -cE "ClearanceBadge|TopSecret" panel-ui/src/components/Telecom/ClearanceBadge.tsx >= 1`
...
|------|--------------|--------|------|
| `panel-ui/src/components/Telecom/ClearanceBadge.tsx` | 0 lines - create new component | Implement feat-telecom-clearance-badge requirements | MED |
...
- [ ] `git status --porcelain` shows `panel-ui/src/components/Telecom/ClearanceBadge.tsx` modified/untracked BEFORE opening PR.
