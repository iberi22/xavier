...
pub async fn start_http_server(port: u16, mcp_port: Option<u16>) -> Result<()> {
    ...
    let state = CliState {
        ...
        agent_registry: SimpleAgentRegistry::new(Some(event_bus.clone())) as Arc<dyn AgentLifecyclePort>,
        panel_store,
        secrets_engine,
        event_bus,
        tasks,
    ...
    let protected_routes = Router::new()
        ...
        .route("/secrets/revoke/{token}", post(crate::cli::proxy::revoke_lease_by_path))
