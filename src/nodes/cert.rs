...
pub fn issue_cert(
    ...
    let wallet_pubkey_hex = crate::crypto::hex_encode(wallet_vk.as_bytes());
    let node_pubkey_hex = crate::crypto::hex_encode(node_pubkey_bytes);
    ...
    let signature_hex = crate::crypto::hex_encode(signature.to_bytes());
...
pub fn verify_cert(
    ...
    let wallet_pk_bytes = crate::crypto::hex_decode(&cert.wallet_pubkey)
    ...
    let sig_bytes = crate::crypto::hex_decode(&cert.signature)
