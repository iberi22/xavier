    ...
    vec![
        ...
        MCPTool {
            ...
            description: "Report Xavier local-first operation mode and reachability. \
                          ...
                          ollama_reachable (bool). Use this before delegating reasoning to Xavier.".to_string(),
    ...
    match name {
        ...
        "xavier_local_status" => {
            ...
            let embedding_reachable =
                health.embedding.latency_ms > 0 || health.embedding.error_rate == 0.0;
            ...
            let val = json!({
                ...
                "fallback_chain": [], // TODO: requires CliState.provider_router - left empty for now
            });
