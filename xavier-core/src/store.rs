...
use crate::memory_hierarchy::{MemoryHierarchyNode, MemoryTree};
use crate::memory::qmd::types::MemoryDocument;
use crate::schema::{resolve_metadata, MemoryLevel, MemoryQueryFilters, RelationKind};
...
impl Default for MemoryRecord {
    fn default() -> Self {
        Self {
            ...
            relation: None,
            clearance: crate::schema::ClearanceLevel::Unclassified,
            revisions: Vec::new(),
            encrypted_dek: None,
            content_iv: None,
            metadata_iv: None,
...
impl MemoryRecord {
    ...
    pub fn is_authorized_for_embedding(
        &self,
        consent_given: bool,
        max_clearance: crate::schema::ClearanceLevel,
    ) -> bool {
        if !consent_given {
            return false;
        }
