...
| MCP stdio | Stable | 16 core tools (was 12): create_memory, search_memory, get_memory, stats, list_projects, get_project_context, sync_gitcore, save_fragment/search_fragments/get_recent_fragments/memoryfragment_get/memoryfragment_delete, plus `codegraph_route` and `codegraph_gods` since wave-24. Security scanning applied uniformly. Protocol 2025-03-26. |
