---
title: "Codegraph to Maturity and Docs Bridge"
description: "Auto-dump .xavier/codegraph.json after index; maturity Layer1 prefers SQLite then dump then grep; align chronicle auto-docs/harvest with code_graph_db_path()"
---
...
Trigger a code-graph scan and verify the auto-dump generation:

```bash
# Perform scan which will trigger automatic soft-fail dump
xavier code scan .

# Check if portable dump is written
ls -la .xavier/codegraph.json
```
